...
import com.alcatel.smartlinkv3.business.sms.HttpSmsOperation.DeleteSmsResponse;
...
/******************** GetSMSContentList  **************************************************************************************/	
    ...
    {	
		private int m_nPage = 0;//Pages that SMS Content list separate,0: return allSMS content.1 : the first page ,every page has 10  SMS content list.2бн..
