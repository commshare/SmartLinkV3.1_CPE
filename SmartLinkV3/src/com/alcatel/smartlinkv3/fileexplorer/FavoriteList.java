...
import com.alcatel.smartlinkv3.fileexplorer.FavoriteDatabaseHelper.FavoriteDatabaseListener;
...
/*    public void onFavoriteListItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (favorite.fileInfo.IsDir) {
            ...
            ((FtpFileViewActivity) activity.getFragment(Util.SDCARD_TAB_INDEX))
