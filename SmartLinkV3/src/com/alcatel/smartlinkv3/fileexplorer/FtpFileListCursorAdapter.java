...
public class FtpFileListCursorAdapter extends CursorAdapter {
    ...
    public FtpFileListCursorAdapter(Context context, Cursor cursor,
            FtpFileViewInteractionHub f, FileIconHelper fileIcon) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        FtpFileListItem.setupFileListItemInfo(mContext, view, fileInfo, mFileIcon,
