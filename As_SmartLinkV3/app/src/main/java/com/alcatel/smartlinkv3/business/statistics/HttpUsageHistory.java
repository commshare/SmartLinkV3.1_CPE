...
/******************** GetUsageHistory  **************************************************************************************/	
    ...
    {			
		String m_strUsageCurrenttime = new String();
        public GetUsageRecord(String strId,String strCurrenttime,IHttpFinishListener callback) 
        {
        	super(callback);  
        	m_strId = strId;
        	m_strUsageCurrenttime = strCurrenttime;
        }
        ...
        protected void buildHttpParamJson() 
        {
        	try {
	        	...
	        	JSONObject usageCurrentTime = new JSONObject();
	        	usageCurrentTime.put("current_time", m_strUsageCurrenttime);
	        	
	        	m_requestParamJson.put(ConstValue.JSON_PARAMS, usageCurrentTime);
