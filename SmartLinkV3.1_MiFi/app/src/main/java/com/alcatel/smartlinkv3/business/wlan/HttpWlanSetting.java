...
public class HttpWlanSetting {
    ...
    public static class GetWlanSetting extends BaseRequest {
        ...
        protected void buildHttpParamJson() {
            try {
                ...
                m_requestParamJson.put(ConstValue.JSON_METHOD, "GetWlanSettings");
    ...
    public static class GetWlanSettingResponse extends BaseResponse {
        ...
        protected enum WlanAPMode {
            E_JRD_WIFI_MODE_2G(0), E_JRD_WIFI_MODE_5G(1), E_JRD_WIFI_MODE_2G_2G(2), E_JRD_WIFI_MODE_5G_5G(3);
    ...
    public static class SetWlanSetting extends BaseRequest {
        ...
        protected void buildHttpParamJson() {
            try {
                m_requestParamJson.put(ConstValue.JSON_RPC, ConstValue.JSON_RPC_VERSION);
                m_requestParamJson.put(ConstValue.JSON_METHOD, "SetWlanSettings");
    ...
    public static class SetWPSPin extends BaseRequest {
        ...
        protected void buildHttpParamJson() {
            ...
            try {
                m_requestParamJson.put(ConstValue.JSON_RPC, ConstValue.JSON_RPC_VERSION);
                m_requestParamJson.put(ConstValue.JSON_METHOD, "SetWPSPin");
    ...
    public static class SetWPSPbc extends BaseRequest {
        ...
        protected void buildHttpParamJson() {
            ...
            try {
                m_requestParamJson.put(ConstValue.JSON_RPC, ConstValue.JSON_RPC_VERSION);
                m_requestParamJson.put(ConstValue.JSON_METHOD, "SetWPSPbc");
    ...
    public static class getWlanSupportModeRequest extends BaseRequest {
        ...
        protected void buildHttpParamJson() {
            ...
            try {
                m_requestParamJson.put(ConstValue.JSON_RPC, ConstValue.JSON_RPC_VERSION);
                m_requestParamJson.put(ConstValue.JSON_METHOD, "GetWlanSupportMode");
