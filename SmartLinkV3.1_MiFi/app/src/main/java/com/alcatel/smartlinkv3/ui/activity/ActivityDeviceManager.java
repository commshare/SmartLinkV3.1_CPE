...
public class ActivityDeviceManager extends BaseActivity implements OnClickListener {
    ...
    private void getLocalMacAddress() {
        ...
        m_strLocalMac = getMac();//info.getMacAddress();
    }
    ...
    public String getMac() {
        ...
        try {
            ...
            byte[] addr = interfaces.getHardwareAddress();
            ...
            mac = buf.toString();
            Log.d("DeviceReceiver", "interfaceName=" + interfaces.getName() + ", mac=" + mac);

        } catch (SocketException e) {
            Log.d("---mac", e.toString());
        }
        return mac;
    }
