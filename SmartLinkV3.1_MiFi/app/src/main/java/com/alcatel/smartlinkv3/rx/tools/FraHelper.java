...
public class FraHelper {
    ...
    /**
     * fragment切换辅助类(单个class)
     *
     * @param activity
     * @param singleClazz
     * @param contain
     */
    public FraHelper(FragmentActivity activity, Class singleClazz, int contain) {
        this.activity = activity;
        this.fm = activity.getSupportFragmentManager();
        this.clazzs = new Class[]{singleClazz};
        this.initClass = singleClazz;
        this.contain = contain;
        this.tags = getTags();
        init(initClass);// 初始化fragment
    }
