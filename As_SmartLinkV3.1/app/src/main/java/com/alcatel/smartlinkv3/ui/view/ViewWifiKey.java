...
//		}
	...
	private void updateUI(){
		...
		if(statistic.HMonthlyPlan!=0)
	    {
			...
			m_homedata.setText(CommonUtil.ConvertTrafficToStringFromMB(this.m_context, m_UsageRecordResult.HUseData)+" of "
					+ CommonUtil.ConvertTrafficToStringFromMB(this.m_context, statistic.HMonthlyPlan));
