...
import com.alcatel.wifilink.business.DeviceManager;
import com.alcatel.wifilink.business.LanManager;
import com.alcatel.wifilink.business.NetworkManager;
import com.alcatel.wifilink.business.PowerManager;
import com.alcatel.wifilink.business.SMSManager;
import com.alcatel.wifilink.business.SharingManager;
import com.alcatel.wifilink.business.SimManager;
import com.alcatel.wifilink.business.StatisticsManager;
import com.alcatel.wifilink.business.SystemManager;
import com.alcatel.wifilink.business.UpdateManager;
import com.alcatel.wifilink.business.UserManager;
import com.alcatel.wifilink.business.WanManager;
import com.alcatel.wifilink.business.WlanManager;
...
public class MessageUti {
    ...
    public static String SYSTEM_GET_SYSTEM_INFO_REQUEST = "com.alcatel.smartlinkv3.business.system.getsysteminfo";
    ...
    public static String SYSTEM_SET_DEVICE_POWER_OFF = "com.alcatel.smartlinkv3.business.setDevicePowerOff";
    ...
    /**************************WAN message start*******************************************************************************/
    public static String WAN_GET_WAN_SETTINGS = "com.alcatel.smartlinkv3.business.wan.getWanSettings";
    public static String WAN_SET_WAN_SETTINGS = "com.alcatel.smartlinkv3.business.wan.setWanSettings";
    /**************************WAN message end*********************************************************************************/
    ...
    public static void intHttpMethods() {
        ...
        /********************WAN method start**********************/
        httpMethods.put(WAN_GET_WAN_SETTINGS, new HttpMethodUti(WanManager.class, "getWanInfo"));
        httpMethods.put(WAN_SET_WAN_SETTINGS, new HttpMethodUti(WanManager.class, "setWanSetting"));
        /********************WAN method end**********************/
        ...
        httpMethods.put(UPDATE_SET_DEVICE_START_FOTA_UPDATE, new HttpMethodUti(UpdateManager.class, "startFOTAUpdate"));
