package com.alcatel.wifilink.appwidget;
...
public class Wave extends View {
    ...
    public Wave setTextColor(int color) {
        this.textColor = color;
        textPaint.setColor(textColor);
        return this;
    }

    public Wave setTextSize(int size) {
        this.textSize = size;
        textPaint.setTextSize(textSize);
        return this;
    }

    public Wave setWaveColor(int color) {
     ...
     * @param a 波浪振幅， 默认为 20
     */
    public Wave setAmplitude(int a) {
        this.a = a;
        return this;
    }
     ...
     * @param w 默认为0.5
     */
    public Wave setPalstance(float w) {
        this.w = w;
        return this;
    }
     ...
     * @param ms 默认为4毫秒
     */
    public Wave setRefreshTime(int ms) {
        this.ms = ms;
        return this;
    }
