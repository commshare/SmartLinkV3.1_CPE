...
public class UsageRecordResult extends BaseResult{
	...
	public long MonthlyPlan = 0;//The Max usage date that the connectDeviceList should use, when the real usage is more than this data, the connection must disconnect.
