...
public class LauncherActivity extends Activity {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            startActivity(new Intent(LauncherActivity.this, LoadingActivity.class));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setLayoutParams(new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT));
