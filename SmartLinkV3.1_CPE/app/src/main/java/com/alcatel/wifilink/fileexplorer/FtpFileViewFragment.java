...
import com.alcatel.wifilink.fileexplorer.FtpFileCommandTask.FtpCommandListener;
import com.alcatel.wifilink.fileexplorer.FtpFileCommandTask.MSG_TYPE;
import com.alcatel.wifilink.fileexplorer.FtpFileCommandTask.OnCallResponse;
import com.alcatel.wifilink.fileexplorer.FtpFileCommandTask.TransferTracker;
import com.alcatel.wifilink.fileexplorer.FtpFileExplorerTabActivity.OnBackPressedListener;
import com.alcatel.wifilink.fileexplorer.FtpFileViewInteractionHub.Mode;
import com.alcatel.wifilink.fileexplorer.FtpFileViewInteractionHub.UICmd;
import com.alcatel.wifilink.fileexplorer.FtpFileViewInteractionHub.uiCommandListener;
...
public class FtpFileViewFragment extends Fragment implements IFileInteractionListener, OnBackPressedListener, OnRequestExListener {
    ...
    private void showDLDialog(String filePath) {
        ...
        mDlProgressBar = (ProgressBar) view.findViewById(R.id.download_progressbar);
            ...
            switch (what) {
                ...
                case MSG_TYPE.MSG_REFRESH_UI:
                    ...
                    for (FTPFile child : listFiles) {
                        ...
                        FileInfo lFileInfo = Util.GetFtpFileInfo(child, path, mFileCagetoryHelper.getFilter(), Settings.instance().getShowDotAndHiddenFiles());
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            throw new ClassCastException(activity.toString() + "must implement IConnectedActionMode");
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRootView = inflater.inflate(R.layout.ftp_file_explorer_list, container, false);
        ...
        mAdapter = new FtpFileListAdapter(mActivity, R.layout.ftp_file_browser_item, mFileNameList, mFileViewInteractionHub, mFileIconHelper);
