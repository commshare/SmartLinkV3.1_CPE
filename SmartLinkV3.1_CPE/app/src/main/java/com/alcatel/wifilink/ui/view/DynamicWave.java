...
public class DynamicWave extends View {
    ...
    public DynamicWave(Context context, AttributeSet attrs) {
        ...
        mXOffsetSpeedOne = CommonUtil.dipToPx(context, TRANSLATE_X_SPEED_ONE);
        mXOffsetSpeedTwo = CommonUtil.dipToPx(context, TRANSLATE_X_SPEED_TWO);
        mXOffsetSpeedThree = CommonUtil.dipToPx(context, TRANSLATE_X_SPEED_THREE);
