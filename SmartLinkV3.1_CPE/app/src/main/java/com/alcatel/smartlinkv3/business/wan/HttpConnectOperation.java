...
public class HttpConnectOperation {
    ...
    public static class GetConnectionState extends BaseRequest {
        ...
        public BaseResponse createResponseObject() {
            ...
            return new DataResponse<>(ConnectStatusResult.class, MessageUti.WAN_GET_CONNECT_STATUS_ROLL_REQUSET, m_finsishCallback);
        }
    ...
    public static class GetConnectionSettings extends BaseRequest {
        ...
        public BaseResponse createResponseObject() {
            ...
            return new DataResponse<>(ConnectionSettingsResult.class, MessageUti.WAN_GET_CONNTCTION_SETTINGS_ROLL_REQUSET, m_finsishCallback);
        }
    }
