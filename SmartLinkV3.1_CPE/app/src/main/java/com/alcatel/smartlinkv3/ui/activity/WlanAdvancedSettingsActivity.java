...
public class WlanAdvancedSettingsActivity extends AppCompatActivity {
    ...
    private void loadSettings(){
        ...
        mSsidBroadcast = intent.getIntExtra("ssid_broadcast", 0) == 0;
        ...
        mBandwidth = intent.getIntExtra("bandwidth", 0);
        mMode80211 = intent.getIntExtra("80211_mode", 0);
        mApIsolation = intent.getIntExtra("ap_isolation", 0) == 1;
    }
