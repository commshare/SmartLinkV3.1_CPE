...
public class WaveLoadingView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (mWaveShader != null) {
            ...
            if (!TextUtils.isEmpty(mCenterTitle)) {
                ...
                if (mCenterNum < 10){
                    setCenterText(canvas, 176, 62, mCenterTitle, "MB", middle, 0.4, 0.75);
                } else if (mCenterNum >= 10 && mCenterNum < 100){
                    setCenterText(canvas, 176, 62, mCenterTitle, "MB", middle, 0.33, 1.05);
                } else if (mCenterNum >= 100 && mCenterNum < 1000){
                    setCenterText(canvas, 176, 62, mCenterTitle, "MB", middle, 0.25, 1.55);
                } else {
                    setCenterText(canvas, 176, 62, mCenterTitle, "MB", middle, 0.2, 2.75);
                }
            }
    ...
    private void setCenterText(Canvas canvas, int titleSize, int unitSize, String  mCenterTitle, String unitValue,
                               float middle, double titleWidthRatio, double unitWidthRatio){
        mCenterTitlePaint.setTextSize(titleSize);
        // Draw the stroke of centered text
        canvas.drawText(mCenterTitle, (float) ((getWidth() - middle) * titleWidthRatio),
        ...
        // Draw the centered text
        canvas.drawText(unitValue, (float) ((getWidth() - middle) * unitWidthRatio),
